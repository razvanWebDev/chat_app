...
?>
    <div class="flex items-center justify-center w-screen min-h-screen bg-blue-100 ">
        <div id="login-card"
            ...
            <hr>
            <p class="text-base text-center">Request a new membership</p>
            <form action="" method="post">
                <div class="flex h-10 mb-4 rounded-md shadow-sm">
                    <input type="text" name="full_name" class="flex-1 block rounded-none input rounded-l-md sm:text-sm"
                        placeholder="Full Name*" required>
                    <div
                        class="inline-flex items-center w-12 h-full p-2 border border-l-0 border-gray-300 rounded-r-md bg-gray-50">
                        <img src="img/icons/user.svg" alt="full name" class="object-contain w-full h-full">
                    </div>
                </div>
                <div class="flex h-10 mb-4 rounded-md shadow-sm">
